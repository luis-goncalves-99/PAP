...
namespace PAP
{
    public partial class frmMarcação_Aula_Padel : Form
    {
        string result1;
        string[] strArray;
        string[] strArray1;
        ...
        private void teste1()
        {
            try
            {
                ...
                connect1.Open();
                SqlCommand cmd = connect1.CreateCommand();
                cmd.CommandText = "Select Id_prof from Professor where Nome='" + cbbProfessor.SelectedItem.ToString() + "'and Desporto='Padel'";
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
        ...
        private void frmMarcação_Aula_Padel_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection connect1 = new SqlConnection(Properties.Resources.Connect);
                ...
                connect1.Open();
                SqlCommand cmd = connect1.CreateCommand();
                cmd.CommandText = "Select Nome from Professor where Desporto='Padel'";
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
        ...
        private void Preço()
        {
            ...
            connect.Open();
            SqlCommand cmd = connect.CreateCommand();
            cmd.CommandText = "Select preço from Preço where id_desporto='Padel' and tipo_consumo='Aula'";
            SqlDataReader reader = cmd.ExecuteReader();
            while (reader.Read())
            {
        ...
        private void frmMarcação_Aula_Padel_FormClosing(object sender, FormClosingEventArgs e)
        {
