...
namespace PAP
{
    public partial class frmAlguer_Squash : Form
    {
        string[] strArray;
        string[] strArray1;
        int qtd1;
                ...
                try
                {
                    ...
                    if (check2() == true)
                    {
                        if (check() == true)
                        {
                            ...
                            cmd.ExecuteNonQuery();
                            MessageBox.Show("Aluguer de Squash adicionado à BD");
                            connect.Close();
                            Consumo();
                            Limpeza();
                            False();
        ...
        private void Preço()
        {
            ...
            connect.Open();
            SqlCommand cmd = connect.CreateCommand();
            cmd.CommandText = "Select preço from Preço where id_desporto='Squash' and tipo_consumo='Aluguer'";
            SqlDataReader reader = cmd.ExecuteReader();
            while (reader.Read())
            {
        ...
        private void frmAlguer_Squash_FormClosing(object sender, FormClosingEventArgs e)
        {
