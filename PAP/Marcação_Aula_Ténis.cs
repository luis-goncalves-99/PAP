...
namespace PAP
{
    public partial class frmMarcação_Aula_Ténis : Form
    {
        string result1;
        string[] strArray;
        string[] strArray1;
        ...
        private void teste1()
        {
            try
            {
                ...
                connect1.Open();
                SqlCommand cmd = connect1.CreateCommand();
                cmd.CommandText = "Select Id_prof from Professor where Nome='" + cbbProfessor.SelectedItem.ToString() + "'and Desporto='Ténis'";
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
        ...
        private void frmMarcação_Aula_Ténis_Load(object sender, EventArgs e)
        {            
            try
            {
                SqlConnection connect1 = new SqlConnection(Properties.Resources.Connect);
                ...
                connect1.Open();
                SqlCommand cmd = connect1.CreateCommand();
                cmd.CommandText = "Select Nome from Professor where Desporto='Ténis'";
                SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
        ...
        private void Preço()
        {
            ...
            connect.Open();
            SqlCommand cmd = connect.CreateCommand();            
            cmd.CommandText = "Select preço from Preço where id_desporto='Ténis' and tipo_consumo='Aula'";
            SqlDataReader reader = cmd.ExecuteReader();
            while (reader.Read())
            {
        ...
        private void frmMarcação_Aula_Ténis_FormClosing(object sender, FormClosingEventArgs e)
        {
